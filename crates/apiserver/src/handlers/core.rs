...
pub(crate) async fn core_list_resource<S: Store>(
...
pub(crate) async fn core_get_resource<S: Store>(
    State(state): State<AppState<S>>,
...
pub(crate) async fn core_delete_resource<S: Store>(
    State(state): State<AppState<S>>,
    Path((plural, name)): Path<(String, String)>,
    Extension(user): Extension<UserInfo>,
    headers: HeaderMap,
...
pub(crate) async fn core_delete_collection_resource<S: Store>(
    State(state): State<AppState<S>>,
    Path(plural): Path<String>,
    Query(query): Query<CollectionQuery>,
    Extension(user): Extension<UserInfo>,
...
pub(crate) async fn core_get_resource_status<S: Store>(
    State(state): State<AppState<S>>,
    Path((plural, name)): Path<(String, String)>,
) -> Result<Response, crate::status::StatusError> {
...
pub(crate) async fn core_list_namespaced_resource<S: Store>(
    State(state): State<AppState<S>>,
...
pub(crate) async fn core_get_namespaced_resource<S: Store>(
    State(state): State<AppState<S>>,
...
pub(crate) async fn core_delete_namespaced_resource<S: Store>(
    State(state): State<AppState<S>>,
    Path((ns, plural, name)): Path<(String, String, String)>,
    Extension(user): Extension<UserInfo>,
    headers: HeaderMap,
...
pub(crate) async fn core_delete_collection_namespaced_resource<S: Store>(
    State(state): State<AppState<S>>,
    Path((ns, plural)): Path<(String, String)>,
    Query(query): Query<CollectionQuery>,
    Extension(user): Extension<UserInfo>,
...
pub(crate) async fn core_get_namespaced_resource_status<S: Store>(
    State(state): State<AppState<S>>,
    Path((ns, plural, name)): Path<(String, String, String)>,
) -> Result<Response, crate::status::StatusError> {
...
pub(crate) async fn core_put_namespaced_resource_status<S: Store>(
    State(state): State<AppState<S>>,
    Path((ns, plural, name)): Path<(String, String, String)>,
    headers: HeaderMap,
    body: Bytes,
...
pub(crate) async fn core_patch_namespaced_resource_status<S: Store>(
    State(state): State<AppState<S>>,
    Path((ns, plural, name)): Path<(String, String, String)>,
    headers: HeaderMap,
    body: Bytes,
