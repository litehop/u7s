...
ExecStart=/usr/bin/kubelet \\\\
  ...
  --v=${KUBELET_V} \\\\
  --housekeeping-interval=30s --application-metrics-count-limit=0 \\\\
...
# what production ships). --max-pods/ChangeDetectionStrategy intentionally
# untouched -- operator scope narrowing.
