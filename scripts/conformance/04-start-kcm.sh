...
setsid "\$KCM_BINARY" \\
  ...
  --controllers=csrapproving,csrsigning,garbagecollector,deployment,replicaset,root-ca-cert-publisher,endpoints-controller,endpointslice-controller,endpointslicemirroring-controller,namespace,serviceaccount,daemonset,resourcequota,statefulset,job,cronjob,horizontalpodautoscaling \\
